      ...
      case REAL -> {
        MODULE_CONSTANTS = new ModuleConstants[]{
            ...
            ModuleConstants.builder()
                ...
                .steerId(2)
                .encoderId(3)
                .encoderOffset(Rotation2d.fromRotations(0.447021))
                .steerInverted(true)
                .turnInverted(false)
                .build(),
            // Front Right
            ModuleConstants.builder()
                ...
                .steerId(5)
                .encoderId(6)
                .encoderOffset(Rotation2d.fromRotations(-0.430664).plus(Rotation2d.k180deg))
                .steerInverted(true)
                .turnInverted(false)
                .build(),
            // Back Left
            ModuleConstants.builder()
                ...
                .steerId(8)
                .encoderId(9)
                .encoderOffset(Rotation2d.fromRotations(-0.007812))
                .steerInverted(true)
                .turnInverted(false)
                .build(),
            // Back Right
            ModuleConstants.builder()
                ...
                .steerId(11)
                .encoderId(12)
                .encoderOffset(Rotation2d.fromRotations(0.198486).plus(Rotation2d.k180deg))
                .steerInverted(true)
                .turnInverted(false)
                .build()
        };
