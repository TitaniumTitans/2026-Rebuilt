...
public class FollowPathCustomCommand extends Command {
   ...
   */
  public FollowPathCustomCommand(
  ...
  public static Command warmupCommand() {
    ...
    return new FollowPathCustomCommand(
        ...
        new RobotConfig(
            ...
            0.55),
        () -> true)
        .andThen(Commands.print("[PathPlanner] FollowPathCustomCommand finished warmup"))
