...
public final class ChoreoVars {
    ...
    public static final class Poses {
        public static final Pose2d AltLeftStart = new Pose2d(3.5990639, 5.5381145, Rotation2d.fromRadians(3.1415927));
        public static final Pose2d AltRightStart = new Pose2d(3.6708601, 0.5992599, Rotation2d.fromRadians(3.1415927));
        public static final Pose2d CenterStart = new Pose2d(3.5690639, 4.0334811, Rotation2d.fromRadians(0));
        public static final Pose2d Depot = new Pose2d(1.1308318, 5.9306154, Rotation2d.fromRadians(3.1415927));
