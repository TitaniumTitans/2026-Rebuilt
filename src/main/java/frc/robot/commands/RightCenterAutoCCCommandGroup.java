...
public class RightCenterAutoCCCommandGroup extends SequentialCommandGroup {
  public RightCenterAutoCCCommandGroup(Drive drive, IntakeSubsystem intake, ShooterSubsystem shooter, FeederSubsystem feeder) {
    super(
